          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              ...
              {/* <tr className="bg-white dark:bg-[#101111]/30">
                ...
                <td className="px-6 py-4">{CONSTANTS.CONTACT.skype}</td>
              </tr> */}
              {/* <tr className="bg-white dark:bg-[#101111]/30">
                <th
                  scope="row"
                ...
                <td className="px-6 py-4">                  
                  <a
                    href={CONSTANTS.CONTACT.discord_server}
                    className="font-normal text-blue-700 dark:text-blue-400 dark:hover:text-blue-500 hover:text-blue-800 flex items-center"
                  >
                    {CONSTANTS.CONTACT.discord}
                    <span className="ml-1">
                      <BiLinkExternal />
                    </span>
                  </a>
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              ...
              <tr className="bg-neutral-100 dark:bg-neutral-900">
                ...
                <td className="px-6 py-4">
                  <a
                    href={`https://www.github.com/${CONSTANTS.CONTACT.github}`}
                    className="font-normal text-blue-700 dark:text-blue-400 dark:hover:text-blue-500 hover:text-blue-800  flex items-center"
                  >
                    {CONSTANTS.CONTACT.github}
                    <span className="ml-1">
                      <BiLinkExternal />
                    </span>
                  </a>
