...
const SkillsDescription = () => {
  return (
    ...
    >
      ...
      <p className="text-sm font-light">
        I possess a penchant for crafting scalable Backend code, meticulously
        adhering to established coding standards and best practices.
      </p>
      <div className="flex">
        <div className="inline-block h-[90px] md:h-[90px] min-h-[1em] w-0.5 self-stretch bg-neutral-300 opacity-100 dark:opacity-50 mt-5" />
        <div className="pl-4">
